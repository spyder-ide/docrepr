...
class PlotDirective(Directive):
    ...
    # We allow 0 arguments when code content is provided
    required_arguments = 0
    # We allow up to 2 optional arguments (filepath and function name)
    optional_arguments = 2
    final_argument_whitespace = False

    # Python code content is accepted
    has_content = True
...
def setup(app):
    ...
    app.add_directive('plot', PlotDirective, True, (0, 2, False))
